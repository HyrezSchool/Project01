        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="tugas praktikum/array_buah.php" class="nav-link">
              ...
              <li class="nav-item">
                <a href="tugas praktikum/tugas4_persegipanjang.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
...
<br><hr>
<div>
<h2 style="color: grey;">HASIL INDEX</h2>
...
<div>
<h2 style="color: grey;">RIWAYAT INDEX</h2>
<table class="table table-hover">
  <thead>
    <tr>
      <th scope="col">No</th>
