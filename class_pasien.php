...
<head>
  ...
  <title>Ayo Hitung BMI Anda</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
   ...
   <div class="content">
     ...
     <p>Apa itu BMI dan bagaimana cara menghitungnya? BMI atau Body Mass Index adalah ukuran yang digunakan untuk mengukur proporsionalitas antara tinggi dan berat badan seseorang. BMI merupakan cara yang mudah untuk menilai apakah seseorang mengalami obesitas atau tidak.</p>
     <div class="content">
       <div class="container-fluid">
       <div class='container'>
                  <form class='form-horizontal p-5' action="kalkulatorBMI.php" method="POST">
                      <p style="font-style:italic">Mohon Di Isi Semua Dengan Benar!</p>
                      <!-------->
                      <div class="form-group row ">
                          <label for="inputEmail3" class="col-sm-2 col-form-label">Nama</label>
                          <div class="col-sm-10">
                          <input type="text" class="form-control" id="inputEmail3" name='nama_lengkap' placeholder="Nama Lengkap Anda">
                          </div>
                      </div>
                      <!----> 
                      <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                          <input type="number" class="form-control" id="inputPassword3" name='berat_' placeholder="Berat Badan Anda">
                          </div>
                      </div>
                      <!----> 
                      <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                          <input type="number" class="form-control" id="inputPassword3" name='tinggi_' placeholder="Tinggi Badan Anda">
                          </div>
                      </div>
                      <!----->
                      <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                          <input type="number" class="form-control" id="inputPassword3" name='umur_' placeholder="Umur Anda">
                          </div>
                      </div>
                      <!---->
                      <div class="row">
